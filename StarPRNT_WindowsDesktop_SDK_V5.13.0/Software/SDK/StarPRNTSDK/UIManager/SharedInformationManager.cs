...
namespace StarPRNTSDK
{
    internal static class SharedInformationManager
    {
        ...
        public static string AllReceiptsRegistrationFilePath
        {
            get
            {
                return SMCloudServices.GetRegistrationConfigFilePath();
            }
            set
            {
                SMCloudServices.SetRegistrationConfigFilePath(value);

                Properties.Settings.Default.AllReceiptsRegistrationFilePath = value;
        ...
        public static bool AllReceiptsPrintReceipt
        {
            get
            {
        ...
        public static bool AllReceiptsPrintInformation
        {
            get
            {
        ...
        public static bool AllReceiptsPrintQrCode
        {
            get
            {
