...
namespace CustomMessageBox
{
    public class MessageBoxEx
    {
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text)
        //{
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text, string caption)
        //{
        //    _owner = new WindowInteropHelper(owner).Handle;
        //    Initialize();
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text, string caption, MessageBoxButton buttons)
        //{
        //    _owner = new WindowInteropHelper(owner).Handle;
        //    Initialize();
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text, string caption, MessageBoxButton buttons, MessageBoxImage icon)
        //{
        //    _owner = new WindowInteropHelper(owner).Handle;
        //    Initialize();
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text, string caption, MessageBoxButton buttons, MessageBoxImage icon, MessageBoxResult defResult)
        //{
        //    _owner = new WindowInteropHelper(owner).Handle;
        //    Initialize();
        ...
        //public static MessageBoxResult Show(VisualStyleElement.Window owner, string text, string caption, MessageBoxButton buttons, MessageBoxImage icon, MessageBoxResult defResult, MessageBoxOptions options)
        //{
        //    _owner = new WindowInteropHelper(owner).Handle;
        //    Initialize();
        //    return MessageBox.Show(owner, text, caption, buttons, icon,
